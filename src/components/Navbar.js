...
const Navbar = ({ children }) => {
    ...
    return (
        <div className="drawer drawer-end">
            ...
            <div className="drawer-content flex flex-col">
                {/* <!-- Navbar --> */}
                <div className="w-full navbar fixed top-0 z-50 bg-base-100 lg:px-20 px-5">
                    ...
                    <div className="flex-none hidden lg:block">
                        <ul className="menu menu-horizontal gap-x-2">
                            ...
                            <li className="dropdown dropdown-hover dropdown-end py-2">
  ...
  {/* <!-- this hidden checkbox controls the state --> */}
   <input type="checkbox" data-toggle-theme="dark,light" data-act-class="ACTIVECLASS" /> {/*  data-act-class="ACTIVECLASS" */}
